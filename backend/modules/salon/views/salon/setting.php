...
<tbody>
<tr>
<th>営業日/時間<br><a href="salon_open.html" class="button_small blue">設定する</a></th>
<td><?= $data['salon_open'];?></td>
</tr>
<tr>
...
<td><?= $model->pos_shop_cd; ?><br> <?= $model->salon_id; ?>
</td>
</tr>
<tr>
<th>名称</th>
...
<td>
	...
	<?= Html::activeTextInput($model, 'addr_ken', ['class' => 'input_form', 'id' => 'address1', 'style' => 'width:95%']); ?><br>
	<?= Html::activeTextInput($model, 'addr_shi', ['class' => 'input_form', 'id' => 'address2', 'style' => 'width:95%']); ?><br>
	<?= Html::activeTextInput($model, 'addr_cho', ['class' => 'input_form', 'id' => 'address3', 'style' => 'width:95%']); ?><br>
...
<td>
    <ul class="open">
        <li>
			<?= Html::activeListBox($model, 'open_date_hour', 
				['10' => '10時', '11' => '11時', '12' => '12時', '13' => '13時', '14' => '14時', '15' => '15時', '16' => '16時', '17' => '17時', '18' => '18時', '19' => '19時',
				 '20' => '20時', '21' => '21時', '22' => '22時',
				], ['class' => 'pulldown', 'id' => 'open_h', 'size' => 1]); 
			?>
        </li>
        <li>
			<?= Html::activeListBox($model, 'open_date_min', 
				['05' => '05分', '10' => '10分', '15' => '15分', '20' => '20分',
    ...
    <ul class="close">
        <li>
			<?= Html::activeListBox($model, 'close_date_hour', 
				['10' => '10時', '11' => '11時', '12' => '12時', '13' => '13時', '14' => '14時', '15' => '15時', '16' => '16時', '17' => '17時', '18' => '18時', '19' => '19時',
				 '20' => '20時', '21' => '21時', '22' => '22時',
        ...
        <li>
			<?= Html::activeListBox($model, 'close_date_min', 
				['05' => '05分', '10' => '10分', '15' => '15分', '20' => '20分',
				 '25' => '25分', '30' => '30分', '35' => '35分', '40' => '40分',
				 '45' => '45分', '50' => '50分', '55' => '55分',
...
<th>定休日</th>
<td>
	<?= Html::activeTextInput($model, 'open_other', ['class' => 'input_form', 'style' => 'width:100%;']); ?>
</td>
</tr>
<tr>
<th>予約可能日数</th>
